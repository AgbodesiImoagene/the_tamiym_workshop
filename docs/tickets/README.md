...
| [TTW-023](ttw-023-enforce-account-and-privileged-auth-policy.md)    | P1       | High | In progress | Enforce verification, rate-limit, revocable-session and privileged-auth policy |
...
| [TTW-026](ttw-026-secure-design-share-links.md)                     | P1       | High | Scoped      | Replace permanent plaintext shares with expiring, revocable, digest-only links |
