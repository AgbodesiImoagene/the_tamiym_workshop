...
import { Badge, Button, ConfirmDialog } from '@tamiym/ui';
  ...
  return (
    <>
                    ...
                    >
                      ...
                      <div className="space-y-2 p-4">
                        ...
                        <div className="flex flex-wrap gap-1.5 pt-1">
                          ...
                          <button
                            type="button"
                            onClick={() => setConfirmDesign(design)}
      ...
      <ConfirmDialog
        open={!!confirmDesign}
        onOpenChange={(open) => {
          if (!open) setConfirmDesign(null);
        }}
        title={`Delete "${confirmDesign?.name}"?`}
        description="This cannot be undone."
        confirmLabel="Delete"
        destructive
        onConfirm={() => {
          if (confirmDesign) deleteMutation.mutate(confirmDesign.id);
