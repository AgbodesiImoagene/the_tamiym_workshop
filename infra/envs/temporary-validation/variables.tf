...
variable "do_project_description" {
  ...
  type        = string
  default     = "Tamiym Workshop temporary validation (TTW-062 network + TTW-064 data)."
}
...
variable "postgres_name" {
  description = "Temporary-validation Managed PostgreSQL cluster name."
  type        = string
  default     = "ttw-tmpval-pg"
}

variable "postgres_size" {
  description = "Managed PostgreSQL size slug (same as prod for parity; destroy-friendly)."
  type        = string
...
variable "spaces_name_prefix" {
  description = "Globally unique Spaces bucket name prefix for temporary-validation."
  type        = string
  default     = "ttw-tmpval"
}

variable "spaces_region" {
  description = "Spaces region (Spaces unavailable in lon1)."
  type        = string
  default     = "ams3"
}
